  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-gray-50 to-white py-12 px-4 sm:px-6 lg:px-8">
      ...
      <motion.div
        ...
        className="max-w-md w-full space-y-8 bg-white/80 backdrop-blur-md p-10 rounded-2xl shadow-xl mt-4"
      >
        <div>
          <motion.div
            ...
            className="mx-auto h-16 w-16 rounded-full bg-gradient-to-r from-green-500 to-blue-500 flex items-center justify-center"
          >
          ...
          >
            Contribuez à une ville plus propre
          </motion.p>
        </div>
          ...
          <div className="rounded-md shadow-sm space-y-4">
            <div>
              ...
              <input
                ...
                className="appearance-none relative block w-full px-3 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 focus:z-10 sm:text-sm transition-all"
          ...
          <div>
            ...
            >
              <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                <svg className="h-5 w-5 text-white/70 group-hover:text-white/90 transition-all" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
        ...
        <div className="text-center pt-2">
          <p className="text-sm text-gray-600">
            ...
            <Link to="/register" className="ml-1 font-medium text-green-600 hover:text-green-500 transition-colors">
              Inscrivez-vous
            </Link>
          </p>
        </div>
